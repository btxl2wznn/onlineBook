...
public class GetBookWithPage extends HttpServlet {
    @Override
...
//        System.out.println(page);
        ...
        if(page!=null||!page.equals(""))
        {
            ...
            if(Integer.parseInt(page)>0) {
                int totalpage=readerOnline.pagesNum(20);
                ArrayList<Book> book = readerOnline.queryPageBook((Integer.parseInt(page) - 1)*20, 20);
                if (book.size() > 0 ) {
                    for (Book value : book) {
